...
@Autonomous
public class BlueFarLeftPlacementThroughMiddle extends LinearOpMode {

    public int pixelPlacement;//0 is left, 1 is right

    public BlueFarLeftPlacementThroughMiddle(){
        pixelPlacement = 0;
    }
    ...
    public void runOpMode() {
        ...
        webcam1.setPipeline(new BlueFarLeftPlacementThroughMiddle.examplePipeline());
